...
#Preview {
    CoinSelector(coins: [
        CoinModel(id: UUID(), name: "Ethereum", symbol: "ETH", value: 10545.25, percentage: 49, icon: "e.circle", amountOwned: 0),
        CoinModel(id: UUID(), name: "Bitcoin", symbol: "BTC", value: 262515.351, percentage: 10, icon: "bitcoinsign.circle", amountOwned: 0),
        CoinModel(id: UUID(), name: "Binance Coin", symbol: "BNB", value: 42, percentage: 1, icon: "b.circle", amountOwned: 0)
