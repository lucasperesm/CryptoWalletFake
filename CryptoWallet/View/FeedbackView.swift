...
struct FeedbackView: View {
    ...
    private var subtitleText: String {
        let coinName = coin?.symbol ?? "Ethereum"
        return mode == .buy
...
#Preview {
    FeedbackView(mode: .buy, coin: Coin(name: "ETH", symbol: "Ethereum", value: 10545.25, percentage: 49, icon: "e.circle"), amountInBRL: "1200,00") {
        // noop
    }
}
